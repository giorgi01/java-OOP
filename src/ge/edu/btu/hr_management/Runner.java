...
import ge.edu.btu.hr_management.employee.Developer;
...
public class Runner {
        ...
        public static void main(String[] args) throws IncorrectFormatException {
                ...
                Developer employeeSecond = new Developer("01123123495","Marcus", "East", "CTO", 50000);
